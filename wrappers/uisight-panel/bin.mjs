#!/usr/bin/env node
// `uisight-panel` is a bin inside the `uisight` package, not a package of its own, so
// `npx -y uisight-panel` -- which the README told people to run for months -- failed
