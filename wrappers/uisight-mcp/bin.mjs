#!/usr/bin/env node
// `uisight-mcp` is a bin inside the `uisight` package, not a package of its own, so
// `npx -y uisight-mcp` -- which the README told people to run for months -- failed
